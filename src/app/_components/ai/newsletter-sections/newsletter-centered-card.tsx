    ...
    <div className={`py-16 sm:py-24`}>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Stay Updated with Our Worklife Newsletter
          </h2>
          <p
          ...
          >
            Subscribe to our newsletter to receive the latest updates on work, money, and life. Get exclusive insights, discounts, and early access to our new features.
          </p>
